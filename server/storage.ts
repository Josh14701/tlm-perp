...
export class MemStorage implements IStorage {
  ...
  private seedData() {
    ...
    // ── Clients ─────────────────────────────────────
    const clientBloom: Client = { id: "c-1", businessName: "Bloom Botanicals", industry: "Retail / Wellness", website: "https://bloombotanicals.com.au", mrr: 3200, status: "active", contractStart: dateStr(180), contractEnd: dateStr(-185), notes: "Organic skincare and plant-based wellness products. Strong Instagram presence.", assignedTeam: ["u-1", "u-3"], createdAt: d(180) };
    const clientVelocity: Client = { id: "c-2", businessName: "Velocity Fitness", industry: "Health & Fitness", website: "https://velocityfitness.com.au", mrr: 4500, status: "active", contractStart: dateStr(150), contractEnd: dateStr(-215), notes: "Premium gym chain with 4 locations. Focus on TikTok and Instagram Reels.", assignedTeam: ["u-2", "u-4"], createdAt: d(150) };
    const clientLuna: Client = { id: "c-3", businessName: "Luna Beauty Co", industry: "Beauty & Cosmetics", website: "https://lunabeautyco.com.au", mrr: 5800, status: "active", contractStart: dateStr(90), contractEnd: dateStr(-275), notes: "Indie beauty brand targeting Gen Z. Heavy influencer collab strategy.", assignedTeam: ["u-1", "u-2", "u-4"], createdAt: d(90) };
    const clientTechNova: Client = { id: "c-4", businessName: "TechNova Solutions", industry: "SaaS / Technology", website: "https://technova.io", mrr: 2800, status: "onboarding", contractStart: dateStr(14), contractEnd: dateStr(-351), notes: "B2B SaaS company. Need LinkedIn and thought leadership strategy.", assignedTeam: ["u-1", "u-3"], createdAt: d(14) };
    const clientCoastal: Client = { id: "c-5", businessName: "Coastal Living Realty", industry: "Real Estate", website: "https://coastallivingrealty.com.au", mrr: 1500, status: "paused", contractStart: dateStr(240), contractEnd: dateStr(10), notes: "Paused services during slow market. Retainer on hold.", assignedTeam: ["u-3"], createdAt: d(240) };
    const clientEmber: Client = { id: "c-6", businessName: "Ember & Oak Restaurant", industry: "Hospitality / F&B", website: "https://emberandoak.com.au", mrr: 0, status: "churned", contractStart: dateStr(300), contractEnd: dateStr(30), notes: "Closed account after ownership change. Was a good client.", assignedTeam: [], createdAt: d(300) };
